# prdiffusion progress report (archived before runtime-matched / piecewise update)

This file archives the previous main progress report before the repo was updated with:

- runtime-matched NP runs,
- candidate-scaled reduced-NP runs,
- reduced hybrid analysis,
- piecewise schedule experiments,
- and the resulting shift toward a solver-centered framing.

The full archived text is reproduced below.
