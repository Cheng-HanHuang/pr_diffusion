...
| WARM_hio_aux_gate | HIO warm candidate retained only by clean-free exact-loss margin gate | docs/b21/b21_5_hio_gate_replay_plan.md | 5-image × 8-seed HIO pilot replay | pending matched LF extension, then fresh validation | idea | inherited theta=0.7; support gate: net >= +4/40, harms <=1, HELDOUT4 net >=0, marginal cost <=0.70 | 2026-07-18 | pending replay |
