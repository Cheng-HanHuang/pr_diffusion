...
| WARM_hio | clean-free HIO warm start at step 200 | docs/b21/b21_5_hio_warmstart_smoke_plan.md | image 00046, 3-case smoke | 5-image × 8-seed paired pilot (planned) | smoke-passed | smoke: base 0/3 vs warm 1/3; mean +5.74 dB; cost ratio 0.523; one large rescue and one harm require broader pilot | 2026-07-18 | docs/b21/b21_5_hio_warmstart_smoke.md |
