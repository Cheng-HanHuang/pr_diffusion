...
#SBATCH --gpus=h200:1
#SBATCH --array=0-4%1
#SBATCH --output=logs/prdiff_full5_%A_%a.out
#SBATCH --error=logs/prdiff_full5_%A_%a.err
...
OUT_ROOT="$HOME/out_hpc_compare_no_lowfreq_full5"
