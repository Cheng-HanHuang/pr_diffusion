...
RUN_ROOT = ROOT / "np_ffhq_s2_lambda_sweep"

OUT_SUMMARY = ROOT / "np_ffhq_s2_lambda_sweep_bestof2_summary.csv"
OUT_IMAGE = ROOT / "np_ffhq_s2_lambda_sweep_image_bestof2.csv"
OUT_RUNS = ROOT / "np_ffhq_s2_lambda_sweep_merged_run_level.csv"
...
def main():
    ...
    rows = []
    for path in files:
        tag = tag_after_root(path, "np_ffhq_s2_lambda_sweep")
    ...
    cols = [
        "config_tag", "score_reg_lambda", "alignment_mode", "n_images",
