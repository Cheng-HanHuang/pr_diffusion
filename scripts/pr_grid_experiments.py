...
def main() -> None:
    ...
    if args.mode == "sitcom_lr":
        ...
        settings = [
            {"np_mask_score": True, "np_mask_proj": True, "name": "full"},
            {"np_mask_score": True, "np_mask_proj": False, "name": "score_only"},
            {"np_mask_score": False, "np_mask_proj": True, "name": "projection_only"},
            {"np_mask_score": False, "np_mask_proj": False, "name": "no_masking"},
        ]
