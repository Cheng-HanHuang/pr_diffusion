...
export OUTDIR=/egr/research-pac/huang248/outputs/pr_diffusion/phase_retrieval_20260411/np_ffhq_tuning_fast_stage1_gpu2

export RADII="0.2 0.4"
...
CUDA_VISIBLE_DEVICES=2 bash scripts/run_ffhq25_np_tuning_fast.sh
