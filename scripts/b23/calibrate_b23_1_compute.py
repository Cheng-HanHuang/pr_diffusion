...
def main() -> int:
    ...
    weight_registry = {
        ...
        "calibration_design": {
            ...
            "paired_blocks": 2,
            "recovered_native_samples": 1,
            "ordering": "repeat 0 uses the exact recovered Fresh1 leading sample followed by LF-v1, NP-1, SITCOM-1; repeats 1 and 2 are fully interleaved Fresh1, LF-v1, NP-1, SITCOM-1",
